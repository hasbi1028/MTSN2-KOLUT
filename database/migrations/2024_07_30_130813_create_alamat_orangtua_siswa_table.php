...
class CreateAlamatOrangtuaSiswaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('alamat_orangtua_siswa', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('alamat_orangtua_siswa');
    }
}
